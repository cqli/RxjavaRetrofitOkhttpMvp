...
import com.example.lcq.utils.Constant;
        ...
        Interceptor headerInterceptor = new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                Request.Builder requestBuilder = originalRequest.newBuilder()
                        ...
                        .header("model", DeviceInfo.getInstance( ).getDeviceType())
                        .header("channel", DeviceInfo.getInstance( ).getChannel())
                        .header("version", DeviceInfo.getInstance( ).getOsVersion())
                        .header("display", DeviceInfo.getInstance().getDisplay())
                        .header("sid",
                                "1538732170138")
                        .header("ssid", "17fe26be8e413d4e4ec8965860110475")
                        .header("appversion", DeviceInfo.getInstance()
                                .getVersionCode() + "")
    ...
    private static Interceptor addCacheInterceptor() {
        Interceptor cacheInterceptor = new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                if (!NetworkUtil.isNetworkAvailable(MyApplication.getmContext())) {
